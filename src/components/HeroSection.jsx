        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="flex items-center justify-center px-6 py-3 text-lg font-semibold rounded bg-primary hover:bg-primary/90 text-white transition-colors">
                Ver Productos
                <svg className="ml-2 h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                </svg>
              </button>
              <button className="flex items-center justify-center px-6 py-3 text-lg font-semibold rounded border border-primary text-primary bg-white hover:bg-primary/10 transition-colors">
                Contactar Ahora
              </button>
            </div>
          </div>
